...
[GitHub Repository Branch](https://github.com/WarrenUhrich/lighthouse-labs-ruby-on-rails-review/tree/2024.01.29-web-immersive-a-east-13november2023) | [Vimeo Video Recording](https://vimeo.com/907561305/de702db93f?share=copy) | [Supporting PDF Document](https://github.com/WarrenUhrich/lighthouse-labs-ruby-on-rails-review/blob/2024.01.29-web-immersive-a-east-13november2023/Ruby%20on%20Rails%20Review.pdf)

* [X] Rails - How is it so far?
* [X] MVC Review
* [X] Building an App Prototype

## How has Ruby and Ruby on Rails been goin' so far?

* Easy to read to and understand!
* Don't like reading the documentation (Ruby esp.!)
* Convention over configuration!
* Learning a new language and framework? Good or too toug
h?
    * It is interesting... a little more confused because
 liked JS!
    * Confusing to do things the Ruby/Rails way, tendancy
 to like JS and its frameworks/libraries better!
